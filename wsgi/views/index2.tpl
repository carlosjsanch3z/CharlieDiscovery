...
<html class="no-js">
  <head>
    ...
    <!-- Google fonts-->
    <link rel="stylesheet" href="static/http://fonts.googleapis.com/css?family=Pacifico">
    <link rel="stylesheet" href="static/http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,700">
    <!-- Theme stylesheet-->
